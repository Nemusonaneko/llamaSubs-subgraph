...
export class LlamaSubsFlatRateERC20__subsResult {
  value0: BigInt;
  value1: BigInt;
  value2: i32;
  value3: Address;
...
export class LlamaSubsFlatRateERC20 extends ethereum.SmartContract {
  ...
  subs(param0: BigInt): LlamaSubsFlatRateERC20__subsResult {
    let result = super.call(
      "subs",
    ...
    return new LlamaSubsFlatRateERC20__subsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toI32(),
      result[3].toAddress()
  ...
  try_subs(
    param0: BigInt
  ): ethereum.CallResult<LlamaSubsFlatRateERC20__subsResult> {
    let result = super.tryCall(
      "subs",
      "subs(uint256):(uint208,uint40,uint8,address)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new LlamaSubsFlatRateERC20__subsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toI32(),
        value[3].toAddress()
